             ...
             cc.Class({
                ...
                updatePrice: function () {
                    var t, e, i;
                    this.visitType === ft.type.visit.gold1 ? (t = "获得小型经验药×10", e = ft.value.item.gold, i = ft.value.visit.gold1) : this.visitType === ft.type.visit.gold10 ? (t = "获得小型经验药×100", e = ft.value.item.gold, i = ft.value.visit.gold10) : this.visitType === ft.type.visit.gem1 ? (t = "获得经验药×1", ft.ExtItem.getNum(ft.value.item.recruitTicket) >= 1 ? (e = ft.value.item.recruitTicket, i = 1) : (e = ft.value.item.gem, i = ft.value.visit.gem1)) : this.visitType === ft.type.visit.gem10 ? (t = "获得经验药×10", ft.ExtItem.getNum(ft.value.item.recruitTicket) >= 10 ? (e = ft.value.item.recruitTicket, i = 10) : (e = ft.value.item.gem, i = ft.value.visit.gem10)) : this.visitType === ft.type.visit.limited10 && (t = "", e = this.activity.consumeId, i = this.activity.consumeNum), this.labelTip.string = ftc.language(t), this.spriteIcon.spriteFrame = ft.ExtItem.getLittleIconSprite(e), this.labelPrice.string = i
                },
                tick: function (t) {
